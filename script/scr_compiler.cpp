...
void EmitUnsignedShort(unsigned short)
{
  scrCompileGlob.codePos = TempMallocAlign(sizeof(unsigned));
	*(unsigned *)scrCompileGlob.codePos = value;
}
...
{	
  scrCompileGlob.codePos = TempMallocAlign(sizeof(int));
