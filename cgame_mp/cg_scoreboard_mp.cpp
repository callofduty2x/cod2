...
float __cdecl CG_DrawScoreboard_ListBanner(float * const,float,float,float,int,int *)
{	UNIMPLEMENTED();
}
...
float __cdecl CG_DrawClientScore(float * const,float,struct score_t *,float,int,int,int *,int)
{	UNIMPLEMENTED();
}
...
float __cdecl CG_DrawTeamOfClientScore(float * const,float,int,float,int *,int *)
{	UNIMPLEMENTED();
}
